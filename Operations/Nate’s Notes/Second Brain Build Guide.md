...
![pastedGraphic.png](blob:capacitor://localhost/563fdf59-6dae-4207-8abb-ab854cbbe60d)
...
App: Slack Event: New Message Posted to Channel
...
App: OpenAI (or Anthropic/Claude) Event: Send Prompt
...
App: Notion Event: Find Database Item
...
App: Schedule by Zapier Event: Every Day
...
App: Notion Event: Find Database Items (plural — finds multiple)
...
App: Schedule by Zapier Event: Every Week
...
Build time: 1-2 hours Maintenance: 5 minutes/week Return: Every thought captured, classified, and surfaced without cognitive overhead