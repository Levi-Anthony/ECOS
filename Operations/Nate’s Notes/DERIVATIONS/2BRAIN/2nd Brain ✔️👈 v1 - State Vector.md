...
platform:
  ...
  external_services:
    ...
    - name: "OpenAI"
      role: "Classification and summarization"
  excluded_services:
    - "Slack"
    - "Zapier"
...
core_loop:
  - step: "capture"
    description: "User records raw thought without categorization"
  - step: "classify"
    description: "AI determines destination and structure"
  - step: "route"
    description: "Write to correct Notion database"
  - step: "confirm"
    description: "Immediate feedback to user"
  - step: "fix"
    description: "Correct misclassification without re-entry"
  - step: "resurface"
    description: "Scheduled summaries and reminders"
