...
| **Baseline ID** | The highest thought ID at project initiation; defines the in-scope population |
...
- Baseline ID: [set at project initiation]
- Last processed ID: [updated after each batch]
...
1. **Establish baseline ID** — query MAX(id) from thoughts table, record in HANDOFF.md
