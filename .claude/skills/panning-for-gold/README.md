...
- Working ECB/BRAIN (`ecb-mcp`) setup so the skill can use `search_thoughts` and `capture_thought`
...
- Capture the strongest life/work outcomes into BRAIN (ECB) — see SKILL.md Phase 3.5 for the scope and inner-gate rules
